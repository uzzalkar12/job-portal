            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="inner-header">
                        <h3>Create Your Account as Company</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-6 col-xs-12">
                    <div class="page-login-form box">
                        ...
                        <form class="login-form" method="POST" action="{{ route('company-register') }}">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="input-icon">
                                    <i class="lni-envelope"></i>
                                    <input type="text" class="form-control @error('business_name') is-invalid @enderror"  name="business_name" value="{{ old('business_name') }}"  placeholder="Company Name" required>
                                    @error('business_name')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
